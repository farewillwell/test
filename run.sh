...
WORKSPACE=/data/aoss/heliqun/iter-pi/pi05-ours-no-ent/${task_suite}
SRC_DIR=/data/aoss/heliqun/dataset/pi-src/libero-${task_suite}
...
${PI_PYTHON} -u ours/iter.py \
  ...
  --proposal-noise-scale 1 \
  --critic-encoder-mode  full_pi0\
  > "${task_suite}-iter-${task_id}-rank-qselect5-ent.log" 2>&1